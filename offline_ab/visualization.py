...
def plot_ci(
    ...
    ci: Tuple[float, float], p_value: float,  effect_dict: dict, aa_test: bool = False,
    ...
    *, df: pd.DataFrame, metric_name: str, grouped_column: str = None,
    ...
    if start_line:
        modified_date = datetime.strptime(
            start_line, "%Y-%m-%d") + timedelta(days=exp_duration_in_days)
        plt.axvspan(
